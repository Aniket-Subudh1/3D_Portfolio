...
export const BtnList = [
  ...
  {
    label: "Github",
    link: "https://github.com/Aniket-Subudh1",
    icon: "github",
    newTab: true,
  },
  {
    label: "LinkedIn",
    link: "https://www.linkedin.com/in/aniket-subudh1/",
    icon: "linkedin",
    newTab: true,
  },
  {
    label: "X",
    link: "https://x.com/AniketSubudh1",
    icon: "twitter",
    newTab: true,
  },
  {
    label: "Resume",
    link: "https://docs.google.com/document/d/10vYZPSCZyQDoJtIFby9ja2-PusNzvG7iueSd5IRpAzA/edit?usp=sharing",
    icon: "resume",
    newTab: true,
  },
];
